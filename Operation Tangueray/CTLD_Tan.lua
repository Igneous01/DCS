...
ctld.minimumHoverHeight = 3.0 -- Lowest allowable height for crate hover
...
ctld.pickupZones = {
    ...
    { "US Carrier", "blue", 10, "yes", 0, 1001 }, -- instead of a Zone Name you can also use the UNIT NAME of a ship
}
