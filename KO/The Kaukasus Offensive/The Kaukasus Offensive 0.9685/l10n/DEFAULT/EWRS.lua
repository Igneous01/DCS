...
ewrs.maxThreatDisplay = 3 -- Max amounts of threats to display on picture report (0 will display all)
...
ewrs.maxFriendlyDisplay = 3 -- Limits the amount of friendly aircraft shown on friendly picture
...
"SA-11 Buk SR 9S18M1",	--SA-11 Search Radar
