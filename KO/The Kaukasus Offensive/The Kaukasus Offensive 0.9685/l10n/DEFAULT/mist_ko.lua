...
do
	...
	mist.main = function()
		...
		timer.scheduleFunction(mist.main, {}, timer.getTime() + 0.1)  --reschedule first in case of Lua error
		--timer.scheduleFunction(mist.main, {}, timer.getTime() + 1)  --reschedule first in case of Lua error
		----------------------------------------------------------------------------------------------------------
